 ...
 */
class EntityNotTranslatableEmptyLangcodeTest extends EntityShareClientFunctionalTestBase {
   ...
   * {@inheritdoc}
   */
  protected static $entityTypeId = 'entity_test_not_translatable_el';

  /**
   * {@inheritdoc}
   */
  protected static $entityBundleId = 'entity_test_not_translatable_el';
